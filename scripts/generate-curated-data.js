...
const curatedData = {
  ...
  GB: {
    ...
    regionalNote: 'Scotland is more progressive than England and Wales — the Scottish Parliament passed the Gender Recognition Reform Bill in Dec 2022 to introduce self-ID (removing medical diagnosis requirement). However, the UK Government vetoed it via Section 35 of the Scotland Act (Jan 2023), and the Court of Session upheld the veto (Dec 2023). The bill never became law. De facto, all UK nations still require a medical diagnosis (England/Wales: Gender Recognition Act 2004; Scotland: same GRA 2004 process). Northern Ireland is the most conservative. London, Manchester, and Edinburgh are the most trans-friendly cities. NHS Gender Identity Clinic wait times can exceed 5 years in England.',
